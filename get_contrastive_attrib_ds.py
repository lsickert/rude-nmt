...
if __name__ == "__main__":
    ...
    ds_formal_informal_ko.save_to_disk(
        DATA_FOLDER / "iwslt_labelled_formal_informal_ko"
    )
    ds_informal_formal_ko.save_to_disk(
        DATA_FOLDER / "iwslt_labelled_informal_formal_ko"
    )

    ds_formal_informal_de.save_to_disk(
        DATA_FOLDER / "iwslt_labelled_formal_informal_de"
    )
    ds_informal_formal_de.save_to_disk(
        DATA_FOLDER / "iwslt_labelled_informal_formal_de"
    )
